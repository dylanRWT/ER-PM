...
parent_folder = '/Users/turnerlab/Desktop/ER-PM junctions/HUFP/UIA/Output folder/';
infile =  dir(strcat(parent_folder,'*.mat'));
outputdir = '/Users/turnerlab/Desktop/ER-PM junctions/HUFP/UIA_v2/UIA Output Folder/';
...
for i = 1
    ...
    if xchannel == 0 % if we are not looking at an overlap channel
       load(strcat(parent_folder,filenames{i}),'img_array','mask_array','thresh','px') 
       [X,hc] = UIA_NNMF(img_array,mask_array,thresh,px,px,6,2); 
